...
namespace CloudMath
{
	...
	struct Vector3
	{
		...
		static constexpr Vector3<T> XAxis();
		static constexpr Vector3<T> YAxis();
		static constexpr Vector3<T> ZAxis();
...
#pragma region Constructors & Assignment
		...
		*/
		 ...
		 * @param p_other
		 */
		constexpr Vector3<T>& operator=(Vector3<T>&& p_other) noexcept;
...
#pragma endregion
	...
	using Vector3f = CloudMath::Vector3<float>;
	using Vector3i = CloudMath::Vector3<int>;
}
