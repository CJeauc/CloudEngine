...
#pragma region Constructor & Assignement
	...
	template <typename T>
	constexpr Matrix3<T>::Matrix3(T p_element1, T p_element2, T p_element3,
	...
	template <typename T>
	constexpr Matrix3<T>::Matrix3(Matrix3<T>&& p_other) noexcept
	{
	...
	template <typename T>
	constexpr Matrix3<T>& Matrix3<T>::operator=(Matrix3<T>&& p_other) noexcept
	{
...
#pragma region Addition
	...
	template <typename T>
	constexpr Matrix3<T>& Matrix3<T>::Add(T p_scalar)
	{
		for (T& element : elements)
		{
			element += p_scalar;
	...
	template <typename T>
	constexpr Matrix3<T> Matrix3<T>::Add(const Matrix3<T>& p_left, T p_scalar)
	{
	...
	template <typename T>
	constexpr Matrix3<T>& Matrix3<T>::Add(const Matrix3<T>& p_other)
	{
		for (uint8_t i = 0; i < 9; ++i)
...
#pragma region Subtraction
	...
	template <typename T>
	constexpr Matrix3<T>& Matrix3<T>::Subtract(T p_scalar)
	{
		for (T& element : elements)
		{
			element -= p_scalar;
	...
	template <typename T>
	constexpr Matrix3<T>& Matrix3<T>::Subtract(const Matrix3<T>& p_other)
	{
		for (uint8_t i = 0; i < 9; ++i)
			elements[i] -= p_other.elements[i];
...
#pragma region Scalar Product
	...
	template <typename T>
	constexpr Matrix3<T>& Matrix3<T>::Multiply(T p_scalar)
	{
		for (T& element : elements)
			element *= p_scalar;
		return *this;
	...
	template <typename T>
	constexpr Matrix3<T>& Matrix3<T>::operator*=(T p_scalar)
	{
...
#pragma region Vector Product
	...
	{
		Vector3<T> result;
		result.x = ((this->elements[0] * p_vector.x) + (this->elements[3] * p_vector.y) + (this->elements[6] * p_vector.
			z));
		result.y = ((this->elements[1] * p_vector.x) + (this->elements[4] * p_vector.y) + (this->elements[7] * p_vector.
			z));
		result.z = ((this->elements[2] * p_vector.x) + (this->elements[5] * p_vector.y) + (this->elements[8] * p_vector.
			z));
	...
	{
		Vector3<T> result;
		result.x = ((p_matrix.elements[0] * p_vector.x) + (p_matrix.elements[3] * p_vector.y) + (p_matrix.elements[6] *
			p_vector.z));
		result.y = ((p_matrix.elements[1] * p_vector.x) + (p_matrix.elements[4] * p_vector.y) + (p_matrix.elements[7] *
			p_vector.z));
		result.z = ((p_matrix.elements[2] * p_vector.x) + (p_matrix.elements[5] * p_vector.y) + (p_matrix.elements[8] *
			p_vector.z));
...
#pragma region Matrix Product
	...
	template <typename T>
	constexpr Matrix3<T>& Matrix3<T>::Multiply(const Matrix3<T>& p_other)
	{
		Matrix3<T> previous(*this);

		elements[0] = (previous.elements[0] * p_other.elements[0] +
			previous.elements[3] * p_other.elements[1] +
			previous.elements[6] * p_other.elements[2]);
		elements[1] = (previous.elements[1] * p_other.elements[0] +
			previous.elements[4] * p_other.elements[1] +
			previous.elements[7] * p_other.elements[2]);
		...
		elements[3] = (previous.elements[0] * p_other.elements[3] +
			previous.elements[3] * p_other.elements[4] +
			previous.elements[6] * p_other.elements[5]);
		elements[4] = (previous.elements[1] * p_other.elements[3] +
			previous.elements[4] * p_other.elements[4] +
			previous.elements[7] * p_other.elements[5]);
		elements[5] = (previous.elements[2] * p_other.elements[3] + 
			previous.elements[5] * p_other.elements[4] +
			previous.elements[8] * p_other.elements[5]);

		elements[6] = (previous.elements[0] * p_other.elements[6] +
			previous.elements[3] * p_other.elements[7] +
			previous.elements[6] * p_other.elements[8]);
		elements[7] = (previous.elements[1] * p_other.elements[6] + 
			previous.elements[4] * p_other.elements[7] +
			previous.elements[7] * p_other.elements[8]);
		elements[8] = (previous.elements[2] * p_other.elements[6] +
	...
	constexpr Matrix3<T> Matrix3<T>::Multiply(const Matrix3<T>& p_left, const Matrix3<T>& p_right)
	{
		return Matrix3<T>(
			...
			(p_left.elements[1] * p_right.elements[3]) +
			(p_left.elements[2] * p_right.elements[6]),

			(p_left.elements[0] * p_right.elements[1]) +
			(p_left.elements[1] * p_right.elements[4]) +
			(p_left.elements[2] * p_right.elements[7]),

			(p_left.elements[0] * p_right.elements[2]) +
			(p_left.elements[1] * p_right.elements[5]) +
			(p_left.elements[2] * p_right.elements[8]),

			(p_left.elements[3] * p_right.elements[0]) +
			(p_left.elements[4] * p_right.elements[3]) +
			(p_left.elements[5] * p_right.elements[6]),

			(p_left.elements[3] * p_right.elements[1]) +
			(p_left.elements[4] * p_right.elements[4]) +
			(p_left.elements[5] * p_right.elements[7]),

			(p_left.elements[3] * p_right.elements[2]) +
			(p_left.elements[4] * p_right.elements[5]) +
			(p_left.elements[5] * p_right.elements[8]),

			(p_left.elements[6] * p_right.elements[0]) +
			(p_left.elements[7] * p_right.elements[3]) +
			(p_left.elements[8] * p_right.elements[6]),

			(p_left.elements[6] * p_right.elements[1]) +
			(p_left.elements[7] * p_right.elements[4]) +
			(p_left.elements[8] * p_right.elements[7]),

			(p_left.elements[6] * p_right.elements[2]) +
			(p_left.elements[7] * p_right.elements[5]) + 
			(p_left.elements[8] * p_right.elements[8]));
	}
...
#pragma region Matrix Division
	...
	template <typename T>
	constexpr Matrix3<T>& Matrix3<T>::Divide(const Matrix3<T>& p_other)
	{
...
#pragma region Matrix Operations
	...
	{
		return (p_matrix.elements[0] * ((p_matrix.elements[4] * p_matrix.elements[8]) - (p_matrix.elements[5] * p_matrix.elements[7])) -
			p_matrix.elements[3] * ((p_matrix.elements[1] * p_matrix.elements[8]) - (p_matrix.elements[7] * p_matrix.elements[2])) +
			p_matrix.elements[6] * ((p_matrix.elements[1] * p_matrix.elements[5]) - (p_matrix.elements[4] * p_matrix.elements[2])));
	}
	...
	constexpr Matrix3<T> Matrix3<T>::Translation(const Vector2<T>& p_translation)
	{
		return Matrix3<T>(1, 0, 0,
		                  0, 1, 0,
			p_translation.x, p_translation.y, 1);
	}
	...
	template <typename T>
	constexpr Matrix3<T>& Matrix3<T>::Translate(const Vector2<T>& p_translation)
	{
	...
	{
		return Matrix3<T>(MathTools::MathUtils::Cos(p_rotation), MathTools::MathUtils::Sin(p_rotation), 0,
		                  -MathTools::MathUtils::Sin(p_rotation), MathTools::MathUtils::Cos(p_rotation), 0,
		                  0, 0, 1);
	}
	...
	template <typename T>
	constexpr Matrix3<T>& Matrix3<T>::Rotate(float p_rotation)
	{
	...
	template <typename T>
	constexpr Matrix3<T>& Matrix3<T>::Scale(const Vector2<T>& p_scale)
	{
...
#pragma region Conversions & Accessors
	...
	template <typename T>
	constexpr T& Matrix3<T>::operator()(const uint8_t p_row, const uint8_t p_column)
	{
		if (p_row >= 3 || p_column >= 3)
			throw std::out_of_range(
				"Invalid index : " + std::to_string(p_row) + "," + std::to_string(p_column) + " is out of range");
		return elements[p_row + p_column * 3];
	}

	template<typename T>
	constexpr T Matrix3<T>::operator()(uint8_t p_row, uint8_t p_column) const
	{
		if (p_row >= 3 || p_column >= 3)
			throw std::out_of_range(
				"Invalid index : " + std::to_string(p_row) + "," + std::to_string(p_column) + " is out of range");
	...
	constexpr Vector3<T> Matrix3<T>::GetRow(const uint8_t p_row) const
	{
		...
		return Vector3<T>(elements[p_row], elements[p_row + 3], elements[p_row + 6]);
	}
	...
	constexpr Vector3<T> Matrix3<T>::GetColumn(uint8_t p_column) const
	{
		...
		return Vector3<T>(elements[p_column * 3], elements[p_column * 3 + 1], elements[p_column * 3 + 1]);
	}
	...
	template <typename T>
	constexpr std::string Matrix3<T>::ToString() const
	{
		return std::string(
			std::to_string(elements[0]) + "\t" + std::to_string(elements[3]) + "\t" + std::to_string(elements[6]) + "\n"
			+
			std::to_string(elements[1]) + "\t" + std::to_string(elements[4]) + "\t" + std::to_string(elements[7]) + "\n"
			+
			std::to_string(elements[2]) + "\t" + std::to_string(elements[5]) + "\t" + std::to_string(elements[8]));
	}
...
#pragma endregion
	...
	{
		p_stream << p_matrix.elements[0] << "\t" << p_matrix.elements[3] << "\t" << p_matrix.elements[6] << "\n" <<
			p_matrix.elements[1] << "\t" << p_matrix.elements[4] << "\t" << p_matrix.elements[7] << "\n" <<
			p_matrix.elements[2] << "\t" << p_matrix.elements[5] << "\t" << p_matrix.elements[8] << "\t";
		return p_stream;
	}
}
#endif // ! _MATRIX3_INL
