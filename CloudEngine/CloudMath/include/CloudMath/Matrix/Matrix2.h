...
#pragma region Conversions
		...
		/**
		   ...
		   * @param p_row
		   */
		Vector2<T> GetRow(uint8_t p_row) const;

		/**
		   * Get Column
		   * @param p_column
		   */
		Vector2<T> GetColumn(uint8_t p_column) const;
...
#pragma endregion
	...
	using Matrix2f = CloudMath::Matrix2<float>;
	using Matrix2i = CloudMath::Matrix2<int>;
}
