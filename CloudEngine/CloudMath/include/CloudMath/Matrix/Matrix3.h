...
#pragma region Constructor & Assignement
		 ...
		 * @param p_element9
		 */
		constexpr Matrix3(T p_element1, T p_element2, T p_element3, T p_element4, T p_element5, T p_element6,
		 ...
		 * @param p_other
		 */
		constexpr Matrix3(Matrix3<T>&& p_other) noexcept;
...
#pragma region Addition
		 ...
		 * @param p_scalar
		 */
		constexpr Matrix3<T>& Add(T p_scalar);
		 ...
		 * @param p_scalar
		 */
		static constexpr Matrix3<T> Add(const Matrix3<T>& p_left, T p_scalar);

		/**
		 * Element-wise addition
		 * @param p_other
		 */
		constexpr Matrix3<T>& Add(const Matrix3<T>& p_other);
...
#pragma region Subtraction
		 ...
		 * Element-wise subtraction
		   * @param p_scalar
		   */
		constexpr Matrix3<T>& Subtract(T p_scalar);
		 ...
		 * @param p_other
		 */
		constexpr Matrix3<T>& Subtract(const Matrix3<T>& p_other);
...
#pragma region Scalar Product
		 ...
		 * @param p_scalar
		 */
		constexpr Matrix3<T>& Multiply(T p_scalar);
		 ...
		 * @param p_scalar
		 */
		constexpr Matrix3<T>& operator*=(T p_scalar);
#pragma endregion
...
#pragma region Matrix Product
		 ...
		 * Matrix Product
		   * @param p_other
		   */
		constexpr Matrix3<T>& Multiply(const Matrix3<T>& p_other);
...
#pragma region Matrix Division
		...
		/**
		   ...
		   * @param p_other
		   */
		constexpr Matrix3<T>& Divide(const Matrix3<T>& p_other);
...
#pragma region Matrix Operations
		 ...
		 * @param p_translation
		 */
		constexpr Matrix3<T>& Translate(const Vector2<T>& p_translation);
		 ...
		 * @param p_rotation angle in radians
		 */
		constexpr Matrix3<T>& Rotate(float p_rotation);
		 ...
		 * @param p_scale
		 */
		constexpr Matrix3<T>& Scale(const Vector2<T>& p_scale);
#pragma endregion
...
#pragma region Conversions & Accessors
		...
		*/
		 ...
		 * Return formatted string
		   * @param p_matrix
		   */
		static constexpr std::string ToString(const Matrix3<T>& p_matrix);
...
#pragma endregion
	...
	using Matrix3f = CloudMath::Matrix3<float>;
	using Matrix3i = CloudMath::Matrix3<int>;
}
