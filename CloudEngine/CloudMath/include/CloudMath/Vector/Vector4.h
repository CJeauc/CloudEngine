...
namespace CloudMath
{
	...
	struct Vector4
	{
		...
		* Vector4<T>(1, 0, 0, 1)
		*/
		static constexpr Vector4<T> XAxis();
		/*
		* Vector4<T>(0, 1, 0, 1)
		*/
		static constexpr Vector4<T> YAxis();
		/*
		* Vector4<T>(0, 0, 1, 1)
		*/
		static constexpr Vector4<T> ZAxis();
...
#pragma region Vector Operations
		 ...
		 * @param p_right
		 */
		constexpr static T TripleProduct(const Vector4<T>& p_left, const Vector4<T>& p_middle,
		...
		*/
		constexpr static Vector4<T> Lerp(const Vector4<T>& p_start, const Vector4<T>& p_end,
		...
		* @param p_interpolationCoefficient between 0 and 1, 0 is start, 1 is end
		*/
		constexpr static Vector4<T> Slerp(const Vector4<T>& p_start, const Vector4<T>& p_end,
		                                  float p_interpolationCoefficient);
...
#pragma region Conversions
		...
		* @param p_vector
		*/
		static constexpr std::string ToString(const Vector4<T>& p_vector);

		/*
		 * Convert to vector3 after homogenization
		 */
		...
		* @param p_vector
		*/
		static constexpr Vector3<T> ToVector3(const Vector4<T>& p_vector4);
